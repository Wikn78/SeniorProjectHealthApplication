    ...
    class RecipesViewModel : BaseViewModel 
    {
        ...
        public RecipesViewModel()
        {
            ...
            recipesListDB.AddItem(new RecipesList
            {
                ...
                RecipePicture = "https://www.wellplated.com/wp-content/uploads/2020/12/Healthy-Egg-White-Frittata-Recipe-500x500.jpg",
                Calories = 273,
                Carbs = 6,
                Protein = 15,
                Fat = 21,
            ...
            recipesListDB.AddItem(new RecipesList
            {
                ...
                RecipePicture = "https://lilluna.com/wp-content/uploads/2022/05/chocolate-chip-pancakes-final-resize-10-500x500.jpg",
                Calories = 735,
                Carbs = 95,
                Protein = 13,
                Fat = 35,
            ...
            recipesListDB.AddItem(new RecipesList
            {
                ...
                RecipePicture = "https://simplyhomecooked.com/wp-content/uploads/2022/05/biscuits-and-gravy-recipe-21-500x500.jpg",
                Calories = 771,
                Carbs = 73,
                Protein = 23,
                Fat = 43,
            ...
            recipesListDB.AddItem(new RecipesList
            {
                ...
                RecipePicture = "https://www.wellplated.com/wp-content/uploads/2020/10/Best-Instant-Pot-Stuffed-Peppers-with-meat-500x500.jpg",
                Calories = 419,
                Carbs = 21,
                Protein = 21,
                Fat = 26,
                ...
                Fiber = 5,
                Sugar = 8,
                Ingredients = "1/2 c. uncooked white or brown rice\r\n2 tbsp. extra-virgin olive oil, plus more for drizzling\r\n1 medium yellow onion, chopped\r\n3 cloves garlic, finely chopped\r\n2 tbsp. tomato paste\r\n1 lb. ground beef\r\n1 (14.5-oz.) can diced tomatoes\r\n1 1/2 tsp. dried oregano\r\nKosher salt\r\nFreshly ground black pepper\r\n6 bell peppers, tops and cores removed\r\n1 c. shredded Monterey jack\r\nChopped fresh parsley, for serving",
            ...
            recipesListDB.AddItem(new RecipesList
            {
                ...
                RecipePicture = "https://inquiringchef.com/wp-content/uploads/2020/01/BBQ-Chicken-Salad_square-2974-500x500.jpg",
                Calories = 484,
                Carbs = 35,
                Protein = 33,
                Fat = 20,
            ...
            recipesListDB.AddItem(new RecipesList
            {
                ...
                RecipePicture = "https://www.saltandlavender.com/wp-content/uploads/2021/11/stovetop-mac-and-cheese-recipe-1-500x500.jpg",
                Calories = 900,
                Carbs = 61,
                Protein = 42,
                Fat = 53,
            ...
            recipesListDB.AddItem(new RecipesList
            {
                ...
                RecipePicture = "https://natashaskitchen.com/wp-content/uploads/2018/08/Chicken-Stir-Fry-1-1-500x500.jpg",
                Calories = 366,
                Carbs = 22,
                Protein = 35,
                Fat = 15,
            ...
            recipesListDB.AddItem(new RecipesList
            {
                ...
                RecipePicture = "https://www.recipetineats.com/wp-content/uploads/2020/01/Chicken-Pad-Thai_9-SQ.jpg?w=500&h=500&crop=1",
                Calories = 658,
                Carbs = 59,
                Protein = 36,
                Fat = 30,

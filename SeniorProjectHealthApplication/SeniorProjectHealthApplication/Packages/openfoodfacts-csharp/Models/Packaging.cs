...
namespace OpenFoodFactsCSharp.Models
{
    public class Packaging
    {
        ...
        [JsonProperty("packagings")] public Packagings[] Packagings { get; set; }
    }
    ...
    public class Packagings
    {
        ...
        [JsonProperty("ecoscore_shape_ratio")] public decimal EcoscoreShapeRatio { get; set; }

        [JsonProperty("material")] public string Material { get; set; }

        [JsonProperty("material_shape")] public string MaterialShape { get; set; }
